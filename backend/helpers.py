...
def get_timerange_str(start_date, end_date):
...
def filter_calendar(components, start_date, end_date):
    ...
    if end_date is not None:
        ...
        end_datetime_dt = datetime(end_date.year, end_date.month, end_date.day, end_date.hour, end_date.minute,
                                   end_date.second, 1, pytz.UTC)
    filtered_components = []
