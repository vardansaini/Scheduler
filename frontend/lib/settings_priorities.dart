...
class SettingsPriorities extends StatefulWidget {
  @override
  _SettingsPrioritiesState createState() => _SettingsPrioritiesState();
}

class _SettingsPrioritiesState extends State<SettingsPriorities> {
